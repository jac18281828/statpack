 ...
 */
public class ContinuousPMF extends ContinuousFunction {
    private ContinuousDistribution probabilityDistribution;
    ...
    public ContinuousPMF(ContinuousDistribution pd) {
